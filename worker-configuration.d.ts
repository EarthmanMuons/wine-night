/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 49cf7e4bc2ae42cc26476e133c12312c)
// Runtime types generated with workerd@1.20260811.1 2026-04-07 
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	EVENTS: DurableObjectNamespace<import("./src/index").WineNightEvent>;
	STATS: DurableObjectNamespace<import("./src/index").SiteStats>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "WineNightEvent" | "SiteStats";
	}
